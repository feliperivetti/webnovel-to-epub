...
description: Instructions for checking standards and formats when creating new skills for the agent. Use when the user asks to create or generate a new skill.
---
